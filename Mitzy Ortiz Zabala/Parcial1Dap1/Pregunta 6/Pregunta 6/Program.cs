...
namespace Pregunta_6
{
    class Program
    {
        ...
        {
            Console.WriteLine("OPERACIONES ESTADISTICAS");
            Console.WriteLine("------------------------ ");
            Console.WriteLine();
            //Lista Edad
            cargar();
            listar();
            Console.WriteLine("Suma: " + suma(lst).ToString());
            Console.WriteLine("Promedio: " + promedio(lst).ToString());
            Console.WriteLine("Maximo: " + max(lst).ToString());
            Console.WriteLine("Venta Minimo: " + min(lst).ToString());
            //Salida
            Console.WriteLine();
